 ...
 */
final class Version20240420230320 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP SEQUENCE guitar_id_seq CASCADE');
