...
class tFPDF
{
	...
	function SetFillColor(int|string $r, int $g = null, int $b = null)
	{
	...
	function Cell(float $w, float $h = 0, string $txt = '', mixed $border = 0, int $ln = 0, string $align = '', bool $fill = false, mixed $link = '')
	{
		// Output a cell
		$txt = (string) $txt;
		$k = $this->k;
